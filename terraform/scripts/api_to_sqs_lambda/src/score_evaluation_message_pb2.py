...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SCOREEVALUATIONMESSAGE._serialized_end=470
  _SCOREEVALUATIONMESSAGE_GAMELEVEL._serialized_start=379
  _SCOREEVALUATIONMESSAGE_GAMELEVEL._serialized_end=439
