...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _SCOREEVALUATIONMESSAGE._serialized_end=356
  _SCOREEVALUATIONMESSAGE_GAMELEVEL._serialized_start=296
  _SCOREEVALUATIONMESSAGE_GAMELEVEL._serialized_end=356
